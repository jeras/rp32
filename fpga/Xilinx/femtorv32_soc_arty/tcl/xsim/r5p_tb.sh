...
#
# Generated by Vivado on Sun Feb 20 17:20:46 CET 2022
# SW Build 3367213 on Tue Oct 19 02:47:39 MDT 2021
#
# Copyright 1986-2021 Xilinx, Inc. All Rights Reserved. 
#
# usage: r5p_tb.sh [-help]
# usage: r5p_tb.sh [-lib_map_path]
# usage: r5p_tb.sh [-noclean_files]
# usage: r5p_tb.sh [-reset_run]
#
#*********************************************************************************************************
...
# Script info
echo -e "r5p_tb.sh - Script generated by export_simulation (Vivado v2021.2 (64-bit)-id)\n"
...
elaborate()
{
  xelab --incr --debug typical --relax --mt auto -L dist_mem_gen_v8_0_13 -L xil_defaultlib -L uvm -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot r5p_tb xil_defaultlib.r5p_tb xil_defaultlib.glbl -log elaborate.log
}
...
setup()
{
  case $1 in
    "-lib_map_path" )
      if [[ ($2 == "") ]]; then
        echo -e "ERROR: Simulation library directory path not specified (type \"./r5p_tb.sh -help\" for more information)\n"
        exit 1
      fi
     copy_setup_file $2
    ;;
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb r5p_tb.wdb xsim.dir)
...
check_args()
{
  if [[ ($1 == 1 ) && ($2 != "-lib_map_path" && $2 != "-noclean_files" && $2 != "-reset_run" && $2 != "-help" && $2 != "-h") ]]; then
    echo -e "ERROR: Unknown option specified '$2' (type \"./r5p_tb.sh -help\" for more information)\n"
    exit 1
  fi
