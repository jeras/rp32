...
#
# Generated by export_simulation on Sun Feb 20 17:20:46 CET 2022
#
################################################################################
...
'-reset_run' switch to the './r5p_tb.sh' script.
...
./r5p_tb.sh -noclean_files

For more information on the script, please type './r5p_tb.sh -help'.
