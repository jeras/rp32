...
class degu(pluginTemplate):
    ...
    def initialise(self, suite, work_dir, archtest_env):
        ...
        if   (self.simulator == 'questa'):
            self.dut_exe = f'make -C {os.path.join(self.work_dir, "../../sim/questa/")} -f Makefile.degu'
        elif (self.simulator == 'verilator'):
            self.dut_exe = f'make -C {os.path.join(self.work_dir, "../../sim/verilator/")} -f Makefile.degu'
        else:
            # TODO: __model__ ?
